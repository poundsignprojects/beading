...
Phases 1–5 shipped the full v1 must-have set (Decision #12: draw, erase, undo/redo, print/export) plus save/load and a project library. Per CLAUDE.md's Phase Plan, Phase 6 is: "Same-grid/alternate-palette variant (Decision #8), lightweight relative to a full duplicate (fixes the prior app pain point #3)."
